...
AImoltは、Gemini 3 Flash PreviewとSupabaseを活用した多機能Discordボットです。テキストメッセージへの応答、音声メッセージの文字起こし、コンテンツの解説など、多彩な機能を提供します。
...
- **固定AI設定**: gemini-3-flash-preview、2000トークン、0.95温度で最適化
...
- **AI生成**: 固定最適化設定（gemini-flash-latest、2000トークン、0.95温度）
