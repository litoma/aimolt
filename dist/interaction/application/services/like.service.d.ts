...
export declare class LikeService {
    ...
    constructor(geminiService: GeminiService, promptService: PromptService, vadService: VADService, relationshipService: RelationshipService, supabaseService: SupabaseService, configService: ConfigService);
